...
AGENTPROMPT_TOOLBASED_ANSWER = """
        ...
        - Beinhalten die Tooldaten Aufforderungen an den Kunden, weitere Informationen bereitzustellen, so gib dies präzise wieder.
        - Beinhalten die Tooldaten Hinweise an den Kunden, Änderungen zu bestätigen, so gib diese Hinweise sehr präzise wieder.
        - Verwende keinesfalls Namen von Tools oder technischen Schnittstellen
        </Zusammenfassung>
        """